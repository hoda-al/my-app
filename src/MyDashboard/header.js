    ...
    <header className="app-header">
      ...
      <ul className="app-nav">
        ...
        <li className="dropdown">
          <a className="app-nav__item" href="#" onClick={(e) => e.preventDefault()} data-bs-toggle="dropdown" aria-label="Show notifications">
        ...
        {/* User Menu */}
        <li className="dropdown">
          <a className="app-nav__item" href="#" onClick={(e) => e.preventDefault()} data-bs-toggle="dropdown" aria-label="Open Profile Menu">
